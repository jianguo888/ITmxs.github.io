...
在Go语言的函数中`return`语句在底层并不是原子操作，它分为给返回值赋值和RET指令两步。而`defer`语句执行的时机就在返回值赋值操作后，RET指令执行前。具体如下图所示：![defer执行时机](https://gitee.com/itmxs/images/raw/master/img/defer.png)
...
![扫码关注微信公众号](https://gitee.com/itmxs/images/raw/master/img/defer.png)
